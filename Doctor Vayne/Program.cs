...
namespace DrVayne
{
    class Program
    {
        ...
        public static void Loading_OnLoadingComplete(EventArgs args)
        {
            ...
            SubMenu["Combo"].Add("myhp", new Slider("Use BOTRK if my HP < %", 55, 0, 100));
            ...
            SubMenu["LastHit"].Add("LastHitMana", new Slider("Mana >=", 80, 0, 100));

            SubMenu["LaneClear"] = menu.AddSubMenu("LaneClear", "LaneClear");
            SubMenu["LaneClear"].Add("Q", new CheckBox("Use Q", true));
            SubMenu["LaneClear"].Add("LaneClearMana", new Slider("Mana >=", 85, 0, 100));
            ...
            SubMenu["Misc"].Add("hp", new Slider("HP <=", 25, 0, 100));

            SubMenu["QSS"] = menu.AddSubMenu("Auto QSS/Mercurial", "QSS");
            SubMenu["QSS"].AddGroupLabel("Auto QSS/Mercurial Settings");
            SubMenu["QSS"].Add("use", new KeyBind("Use QSS/Mercurial", false, KeyBind.BindTypes.PressToggle, 'K'));
