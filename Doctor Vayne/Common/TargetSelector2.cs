...
namespace DrVayne.Common
{
    public class TargetSelector2
    {
        ...
        internal static void Initialize()
        {
            ...
            {
                config = MainMenu.AddMenu("Target W", "TargetSelector2");
                ...
                config.Add
                    ("DrawTarget", new CheckBox("Draw Circle on Selected Target", false));
                config.AddSeparator(10);
                var autoPriorityItem =
                    config.Add("AutoPriority", new CheckBox("Auto arrange priorities", true));
                ...
                config["TargetingMode"].Cast<Slider>().CurrentValue = 1;
