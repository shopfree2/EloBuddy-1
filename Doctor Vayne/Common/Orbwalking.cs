    ...
    public static class Orbwalking
    {
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                /* Misc options */
                SubMenu["Orbwalker2"] = MainMenu.AddMenu("Key Vayne", "Key Vayne");
                ...
                SubMenu["Orbwalker2"].Add
                    ("LastHit", new KeyBind("Last hit", false, KeyBind.BindTypes.HoldActive, 'X'));

                SubMenu["Orbwalker2"].Add
                    ("Farm", new KeyBind("Harass With E", false, KeyBind.BindTypes.HoldActive, 'C'));

                SubMenu["Orbwalker2"].Add
                    ("Clear", new KeyBind("JungleClear", false, KeyBind.BindTypes.HoldActive, 'V'));
